  ...
  const contactInfo = [
    {
      ...
      sub: "mailto:transiflow93@gmail.com",
      action: "mailto:transiflow93@gmail.com",
    ...
    },
    {
      ...
      title: "Phone",
      details: "+234 811 810 2812",
      sub: "Mon-Fri, 9am - 6pm",
      action: "tel:+2348118102812",
  ...
  const faqs = [
    {
      ...
      answer: "Within 24 hours on business days.",
    },
    {
      question: "Do you offer demos?",
      answer: "Yes, we offer free product demos for transport operators.",
    },
    {
      question: "Is there a free trial?",
      answer: "Contact us to learn about our trial options.",
    },
  ];
      ...
      <main>
        ...
        >
          ...
          <div className="relative z-10 mx-auto max-w-4xl text-center px-3">
            ...
            >
              Reach out for product demos, partnership discussions, or help with
              onboarding your transport workflow.
            </motion.p>
          </div>
        </section>
              ...
              {contactInfo.map((info, i) => (
                ...
                >
                  ...
                  <div className="relative p-6">
                    <div
                      className={`mb-4 flex h-14 w-14 items-center justify-center rounded-2xl ${info.iconBg} text-white shadow-lg transition-all group-hover:scale-110 group-hover:rotate-6 duration-300`}
                    >
                      {info.icon}
                    </div>

                    <h3 className="text-xl font-bold text-[#0D2024]">
                      {info.title}
                    </h3>

                    <p className="mt-2 text-base font-semibold text-[#007C91]">
                      {info.details}
                    </p>
                ...
                <div className="relative">
                  <div className="mb-6">
                    <div className="inline-flex items-center gap-2 rounded-full bg-[#007C91]/10 px-3 py-1 mb-3">
                      ...
                      <span className="text-xs font-medium text-[#007C91]">
                        We'd love to hear from you
                      </span>
                    </div>
                    <h2 className="text-2xl font-bold text-[#0D2024]">
                      Send us a message
                    </h2>
                  ...
                  {formSubmitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      <div className="group">
                        <label className="mb-2 block text-sm font-semibold text-[#0D2024]">
                          Full Name
                        </label>
                        <input
                          type="text"
              ...
              >
                ...
                <div className="relative overflow-hidden rounded-2xl bg-white p-6 shadow-xl border border-gray-100">
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-[#0D2024]">
                        Quick Answers
                      </h3>
                ...
                <div className="relative overflow-hidden rounded-2xl bg-linear-to-r from-[#007C91]/10 to-transparent border border-[#007C91]/20 p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-semibold text-[#007C91]">
                        Average response time
                      </p>
                      <p className="text-2xl font-bold text-[#0D2024] mt-1">
                        &lt; 24 hours
                      </p>
                      <p className="text-xs text-gray-500 mt-2">
                        We take pride in fast, helpful responses
                      </p>
                    </div>
        ...
        <section className="bg-white px-5 py-16 sm:py-20 md:px-10 lg:px-20">
          <div className="mx-auto max-w-7xl">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-[#0D2024]">
                Visit Our Office
              </h2>
              <p className="text-gray-500 mt-2">
            ...
            <div className="relative overflow-hidden rounded-2xl shadow-2xl group">
              <img
                ...
                onError={(e) => {
                  e.target.src =
                    "https://images.unsplash.com/photo-1569336415962-a4bd9f69cd83?q=80&w=2070&auto=format";
                }}
              />
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <div className="inline-block rounded-xl bg-white/95 backdrop-blur-sm p-4 shadow-xl">
                  <p className="font-bold text-[#0D2024]">
                    Transiflow Headquarters
                  </p>
                  <p className="text-sm text-gray-500">Abuja, Nigeria</p>
                  <a
                    href="#"
                    className="inline-flex items-center gap-1 text-sm text-[#007C91] font-medium mt-2 hover:gap-2 transition-all"
                  >
