...
import { Calendar, Download, Eye, Filter, MapPin, Search } from "lucide-react";
  ...
  return (
    <div className="space-y-6 container mx-auto px-4 py-6 overflow-y-scroll">
      ...
      <Dialog open={!!selectedTrip} onOpenChange={() => setSelectedTrip(null)}>
        <DialogContent className="w-[95vw] sm:max-w-3xl max-h-[90vh] overflow-hidden bg-white">
          <DialogHeader className="sticky top-0 bg-white z-10 border-b pb-3">
            <DialogTitle>Trip Details - {selectedTrip?.id}</DialogTitle>
          </DialogHeader>

          {selectedTrip && (
            <div className="overflow-y-auto max-h-[75vh] pr-2 space-y-6 py-4">
              {/* Top summary */}
